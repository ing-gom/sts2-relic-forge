...
internal static class ForgeLoc
{
    ...
    internal static readonly Dictionary<string, (string en, string ko, string zh)> UiStrings = new()
    {
        ...
        ["UI.SHOP_REFORGE_BODY"] = ("Reforge the relic. Each reforge in the same shop costs more. A curse ends reforging here — Cleanse removes it.",
                                    "유물을 다시 재련합니다. 같은 상점에서 재련할수록 비용이 오릅니다. 저주가 뜨면 이 상점에서의 재련이 끝나며, 정화로만 없앨 수 있습니다.",
                                    "重新锻造遗物。同一商店中每次重铸费用递增。若重铸出诅咒，则本店重铸结束——只能用净化移除。"),
        ["UI.SHOP_REFORGE_ENDED"] = ("A curse ended reforging at this shop. Cleanse it, or reforge again at the next shop.",
                                     "저주가 떠서 이 상점에서는 더 재련할 수 없습니다. 정화하거나 다음 상점에서 다시 재련하세요.",
                                     "诅咒使本店重铸结束。请净化，或到下一个商店再重铸。"),
